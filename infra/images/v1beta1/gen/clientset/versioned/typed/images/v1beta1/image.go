...
import (
	...
	scheme "github.com/shipwright-io/image/infra/images/v1beta1/gen/clientset/versioned/scheme"
...
func newImages(c *ShipwrightV1beta1Client, namespace string) *images {
	return &images{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *images) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1beta1.Image, err error) {
	result = &v1beta1.Image{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("images").
		Name(name).
...
func (c *images) List(ctx context.Context, opts v1.ListOptions) (result *v1beta1.ImageList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta1.ImageList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("images").
...
func (c *images) Create(ctx context.Context, image *v1beta1.Image, opts v1.CreateOptions) (result *v1beta1.Image, err error) {
	result = &v1beta1.Image{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("images").
...
func (c *images) Update(ctx context.Context, image *v1beta1.Image, opts v1.UpdateOptions) (result *v1beta1.Image, err error) {
	result = &v1beta1.Image{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("images").
...
func (c *images) UpdateStatus(ctx context.Context, image *v1beta1.Image, opts v1.UpdateOptions) (result *v1beta1.Image, err error) {
	result = &v1beta1.Image{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("images").
...
func (c *images) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1beta1.Image, err error) {
	result = &v1beta1.Image{}
