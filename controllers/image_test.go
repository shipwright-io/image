...
import (
	...
	imgfake "github.com/shipwright-io/image/infra/images/v1beta1/gen/clientset/versioned/fake"
...
func (t *imgsvc) Get(ctx context.Context, ns, name string) (*imgv1b1.Image, error) {
	return t.imgcli.ShipwrightV1beta1().Images(ns).Get(ctx, name, metav1.GetOptions{})
}
...
func TestImageCreated(t *testing.T) {
	...
	if _, err := imgcli.ShipwrightV1beta1().Images("namespace").Create(
...
func TestImageDeleted(t *testing.T) {
	...
	if err := imgcli.ShipwrightV1beta1().Images("namespace").Delete(
